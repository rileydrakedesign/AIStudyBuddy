...
if (!fs.existsSync(KEY_PATH) || !fs.existsSync(CERT_PATH)) {
    logger.error("SSL certificate or key file not found. Please ensure 'localhost.pem' and 'localhost-key.pem' exist at the specified paths.");
...
connectToDatabase()
    ...
    httpsServer.listen(PORT, () => logger.info(`HTTPS + WS server running at https://localhost:${PORT}`));
})
    .catch((err) => {
