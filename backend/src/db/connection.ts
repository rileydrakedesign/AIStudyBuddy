...
let studyBuddyConnection: mongoose.Connection | null = null;
 ...
 */
async function connectToStudyBuddyDb(): Promise<mongoose.Connection> {
  try {
...
export {
  ...
  connectToStudyBuddyDb,
  disconnectFromStudyBuddyDb
};
